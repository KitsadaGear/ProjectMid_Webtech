...
>>>>>>> Bam
    ...
    <h2 class="mt-5">สามารถพูดคุยกันได้ตาม Social Media:</h2>
    <button type="button" class="btn btn-Warning mr-5 mt-5 mb-5">
      <a href="https://www.facebook.com/"><i class="fab fa-facebook-square fa-5x"></i></a>
      <p>Facebook</p>
    </button>
    <button type="button" class="btn btn-Warning mr-5 mt-5 mb-5">
    ...
    <button type="button" class="btn btn-Warning mr-5 mt-5 mb-5">
      <a href="https://www.instagram.com/?hl=en"><i class="fab fa-instagram fa-5x"></i></a>
      <p>Instagram</p>
    </button>
    <button type="button" class="btn btn-Warning mr-5 mt-5 mb-5">
      <a href="https://twitter.com/?lang=en"><i class="fab fa-twitter-square fa-5x"></i></a>
      <p>Twitter</p>
    </button>
    <button type="button" class="btn btn-Warning mr-5 mt-5 mb-5">
